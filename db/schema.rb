...
ActiveRecord::Schema.define(version: 20160128034034) do
  ...
  add_index 'cameras',
            ...
            name: 'index_cameras_on_recording_session_id',
            using: :btree
  ...
  add_index 'dropbox_photos',
            ['dropbox_event_id'],
            name: 'index_dropbox_photos_on_dropbox_event_id',
            using: :btree
